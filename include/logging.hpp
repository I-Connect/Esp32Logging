...
class Logger
{
  public:
     ...
     */
    inline void makeMessageAndAppend(LogLevel level, const char* msg);
    void makeMessageAndAppend(LogLevel level,
                              const char* filename,
    ...
    void structured_logf(LogLevel level,
                         const char* filename,
                         int linenumber,
                         const char* function,
                         const char* format, ...);
...
class Logging
{
  public:
     ...
     */
    static void setFormatter(LogMessageFormatter formatter) {
